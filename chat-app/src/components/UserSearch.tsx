      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[80vh] flex flex-col overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-200">
          ...
          <button
            ...
            className="w-full mb-4 px-4 py-2 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors flex items-center justify-center gap-2"
          >
          ...
          {isCreatingGroup && (
            <input
              ...
              className="w-full mb-4 px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          )}
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white"
              autoFocus
            />
          </div>
        </div>
            ...
            <div className="space-y-2">
              {displayUsers.map((user) => (
                <button
                  ...
                  className={`
                    w-full p-3 flex items-center gap-3 rounded-lg hover:bg-slate-50 transition-colors border-2
                    ${
        ...
        {isCreatingGroup && selectedUsers.length >= 2 && (
          <div className="p-4 border-t border-slate-200">
            <button
              ...
              className="w-full py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors font-semibold"
            >
